...
function HomeDestinationCard({ travels, index }: ITravelCardProps) {
    ...
    return (
        <div className='flex justify-center'>
            <div className="max-w-sm bg-white rounded-lg shadow m-2 transition-transform duration-300 hover:scale-110">
                ...
                <div className="p-4">
                    <div onClick={handleClick} className="cursor-pointer">
                        ...
                        <svg 
                            xmlns="http://www.w3.org/2000/svg" 
                            className="icon icon-tabler icon-tabler-star" width="15" height="15" viewBox="0 0 24 24" stroke-width="2" stroke="#df5430" fill="none" stroke-linecap="round" stroke-linejoin="round">
  <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
