...
const Home: React.FC = () => {
  return (
    <div>
<header className="mt-8 ml-5 mr-5 relative min-h-[400px] rounded-3xl p-8 md:p-16">
  <div className="grid">
    <Image 
      src={chalten} 
      alt="El Fitz Roy nevado, visto desde lejos" 
      layout="fill" 
      objectFit="cover"
      className="rounded-3xl"
    />
    <div className="pt-28 pr-4 bg-white bg-opacity-50 max-sm:mt-6 p-8 rounded-3xl z-50">
      <div className="relative flex justify-center">
        <Image src={tudestino} alt="tu destino sin límites" className="absolute top-[-60px] 2xl:top-[-90px] w-6/7 md:w-3/4 h-auto max-sm:top-[-10px] mt-2"/>
      </div>
      <h1 className="relative flex justify-center h-auto top-[-90px] font-arialroundedmtbold text-sivoy-blue max-sm:text-center max-sm:text-sm my-4">
        Información sobre turismo accesible
      </h1>

      <div className="flex align-middle justify-center mt-10 z-500">
        <HomeButton />
        <DonationButton />
      </div>
    </div>
      ...
      <section className="text-left mt-10 ml-5">
        <h2 className="font-arialroundedmtbold text-xl md:text-2xl text-sivoy-blue ">Destinos populares</h2>
        <p className="md:text-lg text-sivoy-blue mt-1">
          Descubre los destinos y servicios turísticos accesibles mejor valorados de Argentina.
        </p>
        <HomeGridComponent />
      </section>

      <section className="flex flex-col md:flex-row text-justify mr-9 md:mr-8 md:-mt-2 lg:mt-4 mt-1">
        <div className="flex flex-col items-center ml-6 md:mt-8">
          <a href="https://www.linkedin.com/in/ver%C3%B3nica-lorena-martinez-78a303a6/" className="flex flex-col items-center border shadow-md rounded-3xl hover:scale-105 duration-300 transition-transform w-72 lg:h-80 pt-4">
            ...
            width={180}
            height={180}/>
            <p className="font-arialroundedmtbold text-sivoy-blue text-center mt-2">Verónica Martínez</p>
            <p className="text-sivoy-blue text-center">Directora</p>
        ...
        <div className="ml-4 md:ml-16 w-full xl:w1/2">
  <h2 className="mt-8 font-arialroundedmtbold text-xl md:text-2xl text-sivoy-blue">¿Quiénes somos?</h2>
  <p className="text-sivoy-blue mt-2 text-base md:text-lg">
  ...
  <h2 className="font-arialroundedmtbold text-xl md:text-2xl text-sivoy-blue mt-6">Misión y Visión</h2>
  <p className="text-sivoy-blue mt-2 text-base md:text-lg">
    ...
    <a className="flex justify-end items-center font-arialroundedmtbold text-sivoy-green mt-2" href="/about">
    Ver Más
  ...
  <path d="M19 18v.01" />
      ...
      <section>
        <h2 className="font-arialroundedmtbold text-xl md:text-2xl text-sivoy-blue ml-4 mb-4 xl:ml-5">Nuestras alianzas</h2>
      <div className="mb-16">
<AlliancesGrid />
      </div>
      </section>
