...
import ShareComponent from "@/components/ShareButtonComponent";
...
const TravelDetail = async({ params }: { params: { travelId: string } }) => {
  ...
  return (
    ...
    <div className="bg-white border border-gray-200 rounded-3xl shadow-xl p-6 w-full m-1 mt-8">
  ...
  <span className="font-arialroundedmtbold text-sivoy-green">Volver a destinos</span>
</div>



        {/* Texto de la descripción */}
        <p className="text-sivoy-blue text-lg mb-6 mt-4 text-justify">
          {travels.description}
        </p>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-8">
          <div>
            <h2 className="md:text-lg font-arialroundedmtbold text-sivoy-blue">Sitio web</h2>
            <p className="text-sivoy-blue text-lg ">{travels.website}</p>
          </div>
          <div>
            <h2 className="md:text-lg font-arialroundedmtbold text-sivoy-blue">Dirección</h2>
            <p className="text-sivoy-blue text-lg">{travels.address}</p>
          </div>
          
         <div>
            <h2 className="md:text-lg font-arialroundedmtbold text-sivoy-blue">Email</h2>
            <p className="text-sivoy-blue text-lg">{travels.email}</p>
          </div>
          <div>
            <h2 className="md:text-lg font-arialroundedmtbold text-sivoy-blue">Teléfono</h2>
            <p className="text-sivoy-blue text-lg">{travels.phone}</p>
          </div>
          
          <div>
            <h2 className="md:text-lg font-arialroundedmtbold text-sivoy-blue">Calificación</h2>
            <StarRating rating={travels.averageStars} />
          </div>
          <div>
  <h2 className="md:text-lg font-arialroundedmtbold text-sivoy-blue">Sello de Accesibilidad</h2>
  <p className="text-sivoy-blue text-lg">{travels.accessibilitySealName}</p>
</div>
